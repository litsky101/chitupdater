	...
	<div class="d-flex flex-row flex-column-fluid page">
		<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
			<div class="brand flex-column-auto text-white" id="kt_brand">
				<a id="logoLink" class="brand-logo">
					<h4>CHIT UPDATER</h4>
				</a>
			</div>
				...
				<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
					<ul class="menu-nav">
						<li class="menu-item" aria-haspopup="true">
							...
							<a id="membersLink" class="menu-link">
						...
						<li class="menu-item" aria-haspopup="true">
							...
							<a id ="chitUploadLink" class="menu-link">
		...
		<div id="kt_header" class="header header-fixed">
			<div class="container-fluid d-flex align-items-stretch justify-content-between">
				...
				<div class="text-white h1 mt-5">
					...
					<!-- <a id="logout" class="btn btn-danger" href="<?php //echo URLROOT; ?>/users/logout">Logout</a> -->
