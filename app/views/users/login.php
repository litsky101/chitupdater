<html lang="en">
	...
	<head><base href="">
		...
		<link href="<?php echo URLROOT; ?>/css/pages/login/classic/login-1.css" rel="stylesheet" type="text/css" />
		...
		<link href="<?php echo URLROOT; ?>/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo URLROOT; ?>/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="<?php echo URLROOT; ?>/media/logos/fav.png" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script src="<?php echo URLROOT; ?>/plugins/global/plugins.bundle.js"></script>
